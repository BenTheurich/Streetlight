...
| 12 | Deployment and recovery | Phase 11 | In progress | [Deployment review](docs/PHASE_12_DEPLOYMENT_REVIEW.md): 487-test baseline, startup guards, recovery, and health/restart pass; production WorkOS and public Cloudflare route are active; fresh Test church 1 geocoding, 653-second import, three-packet PDF, reconciliation, Coverage, and Outreach Progress pass; callback and initial Save fixes pass focused checks/builds; test cleanup, final authentication/rate-limit checks, and human approval remain open; backups deferred for pilot |
