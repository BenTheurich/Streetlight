...
| 12 | Deployment and recovery | Phase 11 | In progress | [Deployment review](docs/PHASE_12_DEPLOYMENT_REVIEW.md): 487-test baseline, startup guards, recovery, and health/restart pass; production WorkOS and public Cloudflare route are active; Test church 1 geocoding, 653-second import, three-packet PDF, reconciliation, Coverage, and Outreach Progress pass; test cleanup and deployed sixth-attempt rate limit pass; fresh sign-in, malformed authenticated geocode, and human approval remain open; backups deferred for pilot |
