...
| 12 | Deployment and recovery | Phase 11 | In progress | [Deployment review](docs/PHASE_12_DEPLOYMENT_REVIEW.md): prior canonical checks and local recovery pass; container measurements reject 512 MiB; Google quotas and project budget are saved; Ben approved gb-dev with Cloudflare Tunnel and deferred pilot backups; deployment, current configuration checks, and public workflow remain open |
