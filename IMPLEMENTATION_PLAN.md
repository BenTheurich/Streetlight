...
| 12 | Deployment and recovery | Phase 11 | In progress | [Deployment review](docs/PHASE_12_DEPLOYMENT_REVIEW.md): 487 tests, production build, startup guards, manual recovery, and private gb-dev health/restart checks pass; full host import and three-packet PDF pass with a 1.69 GiB peak; Google keys, quotas, and project budget are configured; Cloudflare connector is healthy with no public route; Ben deferred WorkOS billing activation and pilot backups; public deployment and workflow checks remain open |
